/**
 * From AdminLTE Demo Menu
 * ------------------
 * Deleted some codes to adapt production
 */
$(function () {
    'use strict'
     ...
     *
     */
    var table = $('#tb-forecast').DataTable();

    $('#tb-forecast tbody').on('click', 'tr', function () {
